...
public class MVCFilter implements Filter {
    ...
    private static IMVCLoader classLoader= MVCClassScanHandler.INSTANCE;
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if(filterConfig.getInitParameter(IScanHandler.VAR_SCAN_JAR)!=null){
            MVCClassScanHandler.setProperties(IScanHandler.VAR_SCAN_JAR, filterConfig.getInitParameter(IScanHandler.VAR_SCAN_JAR));
        }
        if(filterConfig.getInitParameter(IScanHandler.VAR_SCAN_CLASSPATH_REGEX)!=null){
            MVCClassScanHandler.setProperties(IScanHandler.VAR_SCAN_CLASSPATH_REGEX, filterConfig.getInitParameter(IScanHandler.VAR_SCAN_CLASSPATH_REGEX));
        }
    ...
    public static void setClassLoader(IMVCLoader classLoader) {
